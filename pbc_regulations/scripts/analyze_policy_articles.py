...
from scripts.extract_policy_texts import TaskPlan, _discover_task_plans
...
def main() -> None:
    ...
    if args.summary is not None:
        ...
        default_path = Path(output_dir).expanduser().resolve() if isinstance(output_dir, str) else summary_path.parent
