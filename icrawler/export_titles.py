...
def _resolve_project_path(path: Path) -> Path:
    """Return *path* as an absolute location relative to the project root."""
...
def copy_documents_by_title(
    ...
    *,
    ...
    destination_abs = _resolve_project_path(destination_dir)
    report = ExportReport()
    ...
    for entry, document in _iter_documents(state):
        ...
        source_path = _resolve_project_path(Path(local_path_value))
